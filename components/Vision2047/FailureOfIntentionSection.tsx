  ...
  return (
    <section className="py-32 bg-gray-50">
      <div className="container mx-auto px-6">
        <FadeIn delay={0.2}>
          <h2 className="text-5xl md:text-7xl font-heading font-bold text-center text-gray-900 mb-24 uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <FadeIn delay={0.2}>
            <div className="bg-white p-10 shadow-2xl border-t-4 border-gray-900 h-full transform md:-translate-y-4 hover:shadow-3xl hover:scale-105 hover:border-t-8 transition-all duration-500 group cursor-pointer">
