        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-5xl">
          ...
          {sitemapSections.map((section, index) => (
            <section key={index} className="mb-10 sm:mb-12 md:mb-16">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-brand-dark mb-5 sm:mb-6 border-b-2 border-brand-gold pb-2">
                {section.title}
              </h2>
              <div className="space-y-5 sm:space-y-6">
                {section.links.map((link, linkIndex) => (
                  <div key={linkIndex} className="group">
                    ...
                    >
                      <h3 className="text-lg sm:text-xl font-semibold text-brand-brown group-hover:text-brand-gold transition-colors mb-1">
                        {link.name}
                      </h3>
          ...
          <section className="mt-12 sm:mt-16 md:mt-20 pt-8 sm:pt-10 border-t-2 border-gray-200">
            <h2 className="text-2xl sm:text-3xl font-heading font-bold text-brand-dark mb-5 sm:mb-6">
              Need Help?
            </h2>
            <div className="bg-gray-50 p-6 sm:p-8 rounded-lg">
              ...
              <div className="space-y-2 text-base sm:text-lg text-gray-700">
                <p>
                  <strong>Email:</strong>{' '}
                  <a href="mailto:hello@solwaste.co" className="text-brand-gold hover:underline">
                    hello@solwaste.co
                  </a>
                </p>
                <p>
                  <strong>Phone:</strong>{' '}
                  <a href="tel:+919429691308" className="text-brand-gold hover:underline">
                    +91-9429691308
                  </a>
                </p>
                <p>
