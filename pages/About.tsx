             ...
             {[
               ...
               <StaggerItem key={idx}>
                 <div className="p-6 sm:p-7 md:p-8 bg-white rounded-premium border-b-4 border-transparent hover:border-gray-900 shadow-premium hover:shadow-premium-lg transition-all duration-400 group">
                   <div className="mb-5 sm:mb-6 text-gray-700 group-hover:text-gray-900 transition-colors flex justify-center items-center mx-auto">{client.icon}</div>
                   <h4 className="font-heading font-bold text-base sm:text-lg md:text-xl text-gray-900 text-center mb-2 uppercase tracking-wide leading-tight">{client.label}</h4>
