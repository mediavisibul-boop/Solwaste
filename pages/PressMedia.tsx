...
const PressMedia = () => {
  ...
  return (
    <div>
      ...
      {/* Press Items Grid */}
      <div className="bg-brand-cream dark:bg-gray-900 py-12 sm:py-16 md:py-20 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
          
          {/* Section Title */}
          <ScrollReveal variant="fadeInUp" viewport={{ once: true, amount: 0.4 }}>
            <div className="text-center mb-10 sm:mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-brand-dark dark:text-gray-100 mb-3 sm:mb-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 xs:gap-5 sm:gap-6 md:gap-8 lg:gap-10 max-w-md mx-auto md:max-w-none">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl sm:text-2xl font-heading font-bold text-brand-dark dark:text-gray-100 mb-3 group-hover:text-brand-gold transition-colors">
                    {item.title}
                  </h3>
          ...
          >
            <div className="inline-block bg-gray-50 dark:bg-gray-800 px-8 py-6 rounded-xl border-2 border-gray-200 dark:border-gray-700">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <a 
                  ...
                  className="inline-flex items-center gap-2 px-8 py-4 bg-white/10 dark:bg-gray-700 text-white dark:text-gray-100 font-bold rounded-lg hover:bg-white/20 dark:hover:bg-gray-600 transition-all hover:scale-105 active:scale-95 border border-white/20 dark:border-gray-600"
                >
                  <Phone size={20} />
                  +91-9429691308
                </a>
