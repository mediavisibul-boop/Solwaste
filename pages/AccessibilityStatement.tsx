    ...
    <div className="pt-20">
      ...
      <div className="bg-gray-900 text-white py-16 sm:py-20 md:py-24">
        <div className="container mx-auto px-4 sm:px-6 max-w-4xl text-center">
          <p className="text-gray-200 text-sm sm:text-base font-semibold uppercase tracking-wider mb-3">Inclusion & Access</p>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-gray-50 border-l-4 border-gray-900 p-4 sm:p-6 mb-8">
              ...
              <p className="text-sm sm:text-base text-gray-700">
                This Accessibility Statement applies to our website <a href="https://www.solwaste.co" className="text-gray-900 hover:underline">www.solwaste.co</a> and our mobile application <strong>Solwaste</strong>.
              </p>
            </div>

            <section className="mb-10">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-gray-900 mb-4 border-b-2 border-gray-900 pb-2">1. Our Commitment to Accessibility</h2>
            ...
            <section className="mb-10">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-gray-900 mb-4 border-b-2 border-gray-900 pb-2">2. Accessibility Standards</h2>
              <p className="text-base sm:text-lg text-gray-700 mb-4">
            ...
            <section className="mb-10">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-gray-900 mb-4 border-b-2 border-gray-900 pb-2">3. Accessibility Features</h2>
              <p className="text-base sm:text-lg text-gray-700 mb-4">
            ...
            <section className="mb-10">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-gray-900 mb-4 border-b-2 border-gray-900 pb-2">4. Ongoing Efforts & Improvements</h2>
              <p className="text-base sm:text-lg text-gray-700 mb-4">
            ...
            <section className="mb-10">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-gray-900 mb-4 border-b-2 border-gray-900 pb-2">5. Known Limitations</h2>
              <p className="text-base sm:text-lg text-gray-700 mb-4">
            ...
            <section className="mb-10">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-gray-900 mb-4 border-b-2 border-gray-900 pb-2">6. Feedback & Assistance</h2>
              <p className="text-base sm:text-lg text-gray-700 mb-4">
            ...
            <section className="mb-10">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-gray-900 mb-4 border-b-2 border-gray-900 pb-2">7. Policy Review & Updates</h2>
              <p className="text-base sm:text-lg text-gray-700 mb-4">
